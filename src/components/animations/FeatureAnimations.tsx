...
export const featureAnimationMap: Record<string, React.ComponentType> = {
  ...
  "zarzadzanie-projektami": ProjektAnimation,
  faktury: QRAnimation,
  oferty: OffertenAnimation,
  "ewidencja-czasu-pracy": ZeitAnimation,
  crm: CRMAnimation,
  urlopy: FerienAnimation,
  "dokumentacja-zdjec": FotoAnimation,
  magazyn: LagerAnimation,
  ksiegowosc: BuchhaltungAnimation,
  "aplikacja-pracownika": AppAnimation,
  "portal-klienta": KundenportalAnimation,
  "umowy-serwisowe": ServiceAbosAnimation,
};
